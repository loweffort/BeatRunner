...
public class leaderBoardHS : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        pnConfiguration.PublishKey = "pub-c-772f166c-2a4b-4638-8040-80d0f437cb1f";
        pnConfiguration.SubscribeKey = "sub-c-e879b02e-5033-11e9-bdf4-8e79f01390ff";
    ...
    void TaskOnClick()
    {
        ...
        // Trying to pass High Score Here, Want to make it under this same function
        // Reason is I want them to enter their name and boom populate Name+Score
        float currentFHS = HUD.SharedInstance.FHScore;
        myObject.score = GetComponent<TextMesh>().text = currentFHS.ToString();
